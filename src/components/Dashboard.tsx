          ...
          return (
            <div key={member.id}
              ...
              <div className="flex items-center gap-2.5 mb-5">
                ...
                <p className="text-[16px] font-normal text-gray-900 truncate min-w-0">{member.name}</p>
                <div className="ml-auto text-right flex-shrink-0">
                  <p className="text-[16px] font-normal text-indigo-500 leading-none">{mdPct}%</p>
                </div>
              </div>
              ...
              <div className="flex gap-1.5">
                {[
                  ...
                  <div key={s.label} className="flex-1 bg-gray-100" style={{ borderRadius: 4, padding: '10px 12px' }}>
                    ...
                    <p className="text-lg font-normal" style={{ color: s.color }}>{s.val}</p>
                  </div>
                ))}
              </div>
              </div>
